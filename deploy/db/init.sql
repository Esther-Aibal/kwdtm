...
-- ----------------------------
INSERT INTO `sys_office` VALUES ('1', '0', '0,', '佳兆业集团', '10', '2', '100000', '1', '1', null, null, null, null, null, null, '1', null, null, '1', '2013-05-27 08:00:00', '1', '2013-05-27 08:00:00', null, '0');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '1', '1', 'admin', '02a3f0772fcca9f415adc990734b45c6f059c7d33ee28362c4852032', '0001', '系统管理员', 'thinkgem@163.com', '8675', '8675', null, null, '127.0.0.1', '2016-05-30 15:11:19', '1', '1', '2013-05-27 08:00:00', '1', '2013-05-27 08:00:00', '最高管理员', '0', null);
...
-- ----------------------------
-- Table structure for `sys_office_temp`
-- ----------------------------
DROP TABLE IF EXISTS `sys_office_temp`;
CREATE TABLE `sys_office_temp` (
...
-- ----------------------------
-- Table structure for `sys_user_temp`
-- ----------------------------
...
`token`  varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '帐号token值' ,
PRIMARY KEY (`id`),
