...
public interface UserDao extends CrudDao<User> {
     ...
     * @return
     */
    public List<User> findUserByOfficeId(@Param("user")User user,@Param("userIds")List<WdtTTaskPerson> userIds);
    ...
    /**
     * 批量插入,type 0 sys_user
     * type 1  sys_user_temp
     */
    public int batchInsert(@Param("list") List<User> list,@Param("type") int type);

    public void deleteAllData(@Param("type")int type);
    public List<Map<String,Object>> findOfficeByUsername(@Param("userName")String userName,@Param("userIds")List<WdtTTaskPerson> userIds);
    
    public List<Map<String,Object>> findOfficeByOfficeName(@Param("userName")String userName,@Param("userIds")List<String> userIds);
    public List<Map<String,Object>> findUserByUsername(@Param("userName")String userName,@Param("userIds")List<String> userIds);
}
