...
public class SystemService extends BaseService implements InitializingBean {
    ...
    public List<User> findUserByOfficeId(String officeId,String useId,String type) {
    	List<WdtTTaskPerson> userIds= null;
    	if(type!= null && type.equals("task") &&StringUtils.isNotEmpty(useId)){
    		WdtTTaskPerson searchWdtTTaskPerson = new WdtTTaskPerson();
			searchWdtTTaskPerson.setTaskId(useId);
			userIds = wdtTTaskPersonDao.findList(searchWdtTTaskPerson);
    		 
    	}
        User user = new User();
        user.setOffice(new Office(officeId));
        return userDao.findUserByOfficeId(user,userIds);
    }
    
    
    @SuppressWarnings("unchecked")
    public List<Map<String,Object>> findOfficeByUsername(String name,String useId,String type) {
    	List<WdtTTaskPerson> userIds= null;
    	if(type!= null && type.equals("task") &&StringUtils.isNotEmpty(useId)){
    		WdtTTaskPerson searchWdtTTaskPerson = new WdtTTaskPerson();
			searchWdtTTaskPerson.setTaskId(useId);
         ...
         List<Map<String,Object>> list = userDao.findOfficeByUsername(name,userIds);
        return list;
    }
    @SuppressWarnings("unchecked")
    public List<Map<String,Object>> findUsersByUsername(String name,String userIds) {
    	List<String> userIdsList=null;
    	if(StringUtils.isNotEmpty(userIds)){
    		userIdsList = Arrays.asList(userIds.split(","));
    	}
        List<Map<String,Object>> list = userDao.findUserByUsername(name,userIdsList);
        return list;
    }
    
    @SuppressWarnings("unchecked")
    public List<Map<String,Object>> findOfficeByOfficeName(String name,String userIds) {
    	List<String> userIdsList=null;
    	if(StringUtils.isNotEmpty(userIds)){
    		userIdsList = Arrays.asList(userIds.split(","));
    	}
        List<Map<String,Object>> list = userDao.findOfficeByOfficeName(name,userIdsList);
        return list;
    }
